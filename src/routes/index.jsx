...
//HNS_추가
import Main from 'pages/main/Main'; //EgovMain
import MainMap from 'pages/main/MainMap'; //EgovAboutSite
import ChartMain from 'pages/chart/ChartMain'; //EgovIntroWork
import Report from 'pages/report/Report'; //EgovDownloadList
import Manager from 'pages/manage/Manager'; //EgovDailyList
import Login from 'pages/user/Login'; //EgovDailyList
import Signup from 'pages/user/Signup'; //EgovDailyList
...
const SecondRoutes = () => {
  ...
  const [loginVO, setLoginVO] = useState({loginVO : {id : "", name : "", email : ""}});
  ...
  return (
    <>
      <Header onChangeLogin={(user) => setLoginVO(user)}/>
      <Routes>
        {/* HNS */}
        ...
        <Route path={URL.MAP} element={<MainMap />} />
        <Route path={URL.CHART} element={<ChartMain />} />
        <Route path={URL.REPORT} element={<Report />} />
        <Route path={URL.MANAGER} element={<Manager />} />
      </Routes>
      <Footer loginUser={loginVO}/>
