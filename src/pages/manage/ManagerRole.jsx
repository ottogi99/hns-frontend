...
//                       currentPosts(dataSheet).map((data, index) =>
                       dataSheet.map((data, index) =>
                            <tr key = {index} className = 'label'>
                               ...
                               <td><input type = 'text' className = {'roleNm'+index} Value = {data.ROLE_NAME} onChange={(e)=>setRoleNm(e.target.value)} readOnly/></td>
                               <td><input type = 'text' className = {'roleDesc'+index} Value = {data.ROLE_DESC} onChange={(e)=>setRoleDesc(e.target.value)} readOnly/></td>
                               <td><input type = 'number' className = {'roleSort'+index} Value = {data.ROLE_SORT} onChange={(e)=>setRoleSort(e.target.value)} readOnly/></td>
                               <td>
